...
int main(int argc, char* argv[]){
    ...
    else
    {
        ...
        // int total_samples = 2 * len_symbols_ups;
        // int index = 0;

        // while (1)
        // {
        //     void *tx_buffs[] = { tx_samples + index };
        //     int chunk = 1920;

        //     if (index + chunk > total_samples) {
        //         chunk = total_samples - index;
        //     }

        //     long long tx_time = timeNs + 4000000LL;
        //     // long long tx_time = timeNs + (chunk * 1e9 / config1.sample_rate);
